...
HW_done_count = 12
HW_hours_spended = 1.5
HW_course_name = 'Python'
HW_average_spended_hours = HW_hours_spended / HW_done_count

print (f'Average spended hours: {HW_average_spended_hours}')
...
Примечания:
    ...
    Для вывода значений на экран используйте функцию print(a, b, c), где a, b, c - данные которые выводяться на экран.
